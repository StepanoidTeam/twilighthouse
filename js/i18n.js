...
`,
    ...
    'shop.stockTitle': 'Goods in stock',
    'shop.infoTitle': 'About goods',
    'shop.infoText':
      'Goods apply during the current run. Effects do not stack with matching perks.',
    'shop.buy': 'Buy',
    ...
    'settings.languageDesc': 'Choose text and interface language',
    'settings.music': 'Music',
    'settings.musicDesc': 'Background music volume',
    'settings.sfx': 'Sound',
    'settings.sfxDesc': 'Sound effects volume',
    'settings.displayName': 'Leaderboard Name',
    'settings.displayNameDesc': 'Your name in the leaderboard',
    ...
    'resultStats.perksTitle': 'Perks collected',
    ...
    'resultReview.smugglers.title': 'Smugglers',
    'resultReview.smugglers.reached': 'Reached',
    'resultReview.smugglers.sunk': 'Sank',
    'resultReview.cops.title': 'Police',
    'resultReview.cops.reached': 'Reached',
    'resultReview.cops.sunk': 'Sunk',
    'resultReview.mermaids.title': 'Mermaids',
    'resultReview.mermaids.attacked': 'Attacked',
    'resultReview.mermaids.repelled': 'Repelled',
    'resultReview.kraken.title': 'Kraken',
    'resultReview.kraken.destroyed': 'Destroyed lighthouse',
    'resultReview.kraken.banished': 'Banished',
...
`,
    ...
    'leaderboard.subtitle': '灯塔守卫排行 - 谁坚持最久',
    'leaderboard.loading': '加载中…',
    'leaderboard.loadError': '排行榜加载失败',
    'leaderboard.empty': '还没有人上榜 - 你来当第一名吧！',
    'leaderboard.you': '（你）',
    'leaderboard.col.rank': '#',
    'leaderboard.col.name': '名称',
    'leaderboard.col.level': '等级',
    'leaderboard.col.time': '最佳',
    'leaderboard.col.date': '日期',

    ...ACHIEVEMENTS_I18N.zh,

    'shop.title': '港口商店',
    'shop.playerLevel': '等级 {n}',
    'shop.nightsWon': '存活夜晚：{n}',
    'shop.wallet': '库存',
    'shop.stockTitle': '库存商品',
    'shop.infoTitle': '商品说明',
    'shop.infoText': '商品会在本局生效。效果不会与相同加成叠加。',
    'shop.buy': '购买',
    'shop.upgrade': '升级',
    'shop.owned': '已拥有',
    'shop.maxLevel': '满级',
    ...
    'shop.reset': '重置',
    'shop.resetConfirm': '重置所有购买并返还已花资源？',
    'shop.resetCancel': '取消',
    'shop.resetApply': '重置',
    'shop.items.extra_heart.name': '救生圈',
    'shop.items.extra_heart.desc': '每局开始时 +1 生命。',
    'shop.items.quality_wick.name': '结实灯芯',
    'shop.items.quality_wick.desc': '灯多燃烧约 25%。',
    'shop.items.fresnel_lens.name': '菲涅尔透镜',
    'shop.items.fresnel_lens.desc': '光束持续约 +20%。',
    'shop.items.lamp_oil_crate.name': '灯油箱',
    'shop.items.lamp_oil_crate.desc': '灯油储备 +20。',
    'shop.items.spare_generator.name': '备用发电机',
    'shop.items.spare_generator.desc': '每晚开始时获得额外充能。',
    'shop.items.fast_gear.name': '高速齿轮',
    'shop.items.fast_gear.desc':
      '每级光束转速 +10%（最高 +30%）。当前 +{bonus}%，下级 +{nextBonus}%。',
    'shop.items.cold_lamp.name': '冷光灯',
    'shop.items.cold_lamp.desc': '灯油消耗约 -12%。',
    'shop.items.moonlight.name': '月光',
    'shop.items.moonlight.desc': '光束外，灯塔周围仍微亮。',
    ...
    'settings.languageDesc': '选择文本和界面语言',
    'settings.languageHelp': '缺少你的语言？',
    'settings.contactUs': '联系',
    'settings.music': '音乐',
    'settings.musicDesc': '背景音乐音量',
    'settings.sfx': '音效',
    'settings.sfxDesc': '音效音量',
    'settings.displayName': '排行榜名称',
    'settings.displayNameDesc': '你在排行榜中的名称',
    'settings.displayNamePlaceholder': '输入名称…',
    ...
    'settings.displayNameAnon': '游客模式。你的名称会显示在排行榜中。',
    'settings.displayNameEmail': '你的名称会显示在排行榜中。',
    'settings.displayNameTooShort': '名称不能为空',
    'settings.displayNameTooLong': '名称最多 30 个字符',
    'settings.displayNameSaving': '保存中…',
    'settings.displayNameEmpty': '请输入名称',
    'lang.russian': 'Русский',
    'lang.english': 'English',
    'lang.chinese': '简体中文',
    'profile.guest': '游客',
    ...
    'gameOver.mermaids': '🧜‍♀️ 美人鱼占领灯塔！',
    'gameOver.police': '🚔 被捕！警察占领灯塔！',
    'gameOver.kraken': '🦑 克拉肯占领灯塔！',
    'gameOver.pattinson': '📦 火药耗尽！守塔人把实习生扔下悬崖！',
    'gameOver.score': '💀 救下 {score}/{total} 艘船',
    'win.message': '🎉 胜利！救下全部 {total} 艘船！',
    'win.messageTime': '🎉 胜利！救下全部 {total} 艘船！用时：{time}',
    'win.title': '🎉 胜利！',
    'win.nightSubtitle': '熬过这一夜！',
    'win.statLamps': '油灯',
    'win.statCrates': '货箱',
    'win.statTime': '用时',
    'resultStats.cargoTitle': '收集的货物',
    'resultStats.perksTitle': '已获得加成',
    'resultStats.title': '夜间回顾',
    'resultStats.playerLevel': '等级',
    'resultStats.deliveredBoats': '救下走私船',
    'resultStats.smugglersSunk': '沉没走私船',
    'resultStats.sunkCops': '击沉警船',
    'resultStats.repelledMermaids': '吓退美人鱼',
    'resultStats.repelledKraken': '击退克拉肯',
    'resultStats.copsArrived': '警船到达灯塔',
    'resultStats.mermaidsArrived': '美人鱼到达灯塔',
    'resultStats.krakensArrived': '克拉肯到达灯塔',
    'resultReview.smugglers.title': '走私船',
    'resultReview.smugglers.reached': '抵达',
    'resultReview.smugglers.sunk': '沉没',
    'resultReview.cops.title': '警察',
    'resultReview.cops.reached': '抵达',
    'resultReview.cops.sunk': '击沉',
    'resultReview.mermaids.title': '美人鱼',
    'resultReview.mermaids.attacked': '袭击',
    'resultReview.mermaids.repelled': '吓退',
    'resultReview.kraken.title': '克拉肯',
    'resultReview.kraken.destroyed': '摧毁灯塔',
    'resultReview.kraken.banished': '驱逐',
    ...
    'perk.brighter_beam.title': '宽光束',
    'perk.brighter_beam.desc': '光锥变得更宽。',
    'perk.slow_cops.title': '慢速警船',
    'perk.slow_cops.desc': '警船移动得更慢。',
    'perk.beam_width.title': '光束上限',
    ...
    'perk.experienced_keeper.title': '老练守塔人',
    'perk.experienced_keeper.desc': '每晚获得 10% 更多资源。',
    'perk.occult_lamp.title': '诡秘灯',
    'perk.occult_lamp.desc':
      '冰山上的紫色灯会吸引美人鱼并在接触时吓跑她们。克拉肯出现得更频繁。',
    'perk.old_map.title': '古地图',
...
`,
    ...
    'shop.stockTitle': 'Товары на складе',
    'shop.infoTitle': 'О товарах',
    'shop.infoText':
      'Товары действуют в текущем прохождении. Эффекты не складываются с одинаковыми перками.',
    'shop.buy': 'Купить',
    ...
    'settings.languageDesc': 'Выберите язык текста и интерфейса',
    'settings.music': 'Музыка',
    'settings.musicDesc': 'Громкость фоновой музыки',
    'settings.sfx': 'Звуки',
    'settings.sfxDesc': 'Громкость звуковых эффектов',
    'settings.displayName': 'Имя в рейтинге',
    'settings.displayNameDesc': 'Ваше имя в таблице лидеров',
    ...
    'exit.confirm': 'Выйти в меню?',
    'exit.settings': 'Настройки',
    ...
    'resultStats.perksTitle': 'Собранные перки',
    ...
    'resultReview.smugglers.title': 'Контрабандисты',
    'resultReview.smugglers.reached': 'Добралось',
    'resultReview.smugglers.sunk': 'Утонуло',
    'resultReview.cops.title': 'Полиция',
    'resultReview.cops.reached': 'Добралось',
    'resultReview.cops.sunk': 'Потоплено',
    'resultReview.mermaids.title': 'Русалки',
    'resultReview.mermaids.attacked': 'Напало',
    'resultReview.mermaids.repelled': 'Отогнано',
    'resultReview.kraken.title': 'Кракен',
    'resultReview.kraken.destroyed': 'Уничтожил маяк',
    'resultReview.kraken.banished': 'Изгнано',
