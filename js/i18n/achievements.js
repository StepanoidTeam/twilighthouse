export const ACHIEVEMENTS_I18N = {
  ...
  zh: {
    ...
    'achievements.subtitle': '长期目标，贯穿你的每一局',
    'achievements.progress': '{value}/{target}',
    'achievements.complete': '已完成',
    'achievements.points': '分数',
    'achievements.done': '已解锁',
    'achievements.locked': '继续加油',
    'achievements.total_points': '成就点数：{points} ✦',
    'achievements.filter.hide_completed': '隐藏已完成',
    'achievements.filter.show_all': '显示全部',
    'achievements.filter.empty': '目前没有符合筛选条件的成就。',
    'achievements.toast.unlocked': '成就已解锁',
    'achievements.toast.points': '+{points} ✦',
    'achievements.items.first_night.title': '第一个夜晚',
    'achievements.items.first_night.desc': '撑过你的第一个夜晚。',
    ...
    'achievements.items.not_today.desc': '赶走你的第一位美人鱼。',
    'achievements.items.wrong_way.title': '走错路了',
    'achievements.items.wrong_way.desc': '击沉你的第一艘警船。',
    ...
    'achievements.items.full_tank.desc': '在单局中收集 10 盏灯。',
    'achievements.items.cargo_delivered.title': '货物送达',
    'achievements.items.cargo_delivered.desc': '在单局中收集 15 箱违禁品。',
    'achievements.items.wave_of_law.title': '法律之浪',
    'achievements.items.wave_of_law.desc': '赶走 25 艘警船。',
    'achievements.items.siren_whisper.title': '海妖低语',
    'achievements.items.siren_whisper.desc': '赶走 50 位美人鱼。',
    'achievements.items.path_keeper.title': '航线守护者',
    'achievements.items.path_keeper.desc': '护送 50 艘走私船到港口。',
    'achievements.items.last_lamp.title': '最后一盏灯',
    'achievements.items.last_lamp.desc': '在只剩 1 条生命时赢下一夜。',
    ...
    'achievements.items.see_all.desc': '让 3 个目标同时停留在光束中 1 秒。',
  },
  ru: {
